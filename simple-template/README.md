...
Deploy an Azure Container Instance running nepeters personal site.

## Deployment

```
az group create --name simple-template --location eastus

az group deployment create --name simple-template --resource-group simple-template --template-file simple-template/azuredeploy.json
```
