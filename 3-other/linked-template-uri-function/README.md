...
az group deployment create --resource-group linked-template-local --template-uri https://raw.githubusercontent.com/neilpeterson/arm-template-collection/master/linked-template-local/azuredeploy-uri-output.json
```